  ...
  <div class="container p-3 border-black">
    <div class="row p-3 justify-content-center">
      ...
      <div class="col-5 col-sm-5 align-self-center text-center">
        <h1>Shadowsteel Forge. Where Legends Take Shape.</h1>
        <h5>
          Transcending mere craftsmanship to breathe life into ancient
          narratives and birth new stories.
        </h5>
        <h6>Custom Weaponry.</h6>
