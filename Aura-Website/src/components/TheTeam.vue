<template>
  <div class="container profile-container">
    ...
    <div class="row mx-auto d-flex justify-content-center">
      <div class="col-9 col-xl-5 col-lg-5 col-md-10 col-sm-10 text-center m-4">
        <img src="../assets/images/owners/gouvea.png" alt="gouvea" class="profile rounded">
        <h3 class="mt-2">Gouvea</h3>
        <h5>Lead Designer. Marketer. Father.</h5>
        <p>
      ...
      <div class="col-9 col-xl-5 col-lg-5 col-md-10 col-sm-10 text-center m-4">
        ...
        <h3 class="mt-2">Seetelo</h3>
        <h5>Head of Production. Learner. Salesman.</h5>
        <p>
